...
void test1(){
    ...
    for(int i=0;i<10000;i++) my_list.push_back(SomeStruct());
    for(int i=0;i<10000;i++) my_list.erase(my_list.begin());
...
void test2(){
    auto begin = std::chrono::high_resolution_clock::now();
    std::list<SomeStruct,mai::allocator<SomeStruct,10000>> my_list;
    for(int i=0;i<10000;i++) my_list.push_back(SomeStruct());
    for(int i=0;i<10000;i++) my_list.erase(my_list.begin());
    auto end = std::chrono::high_resolution_clock::now();
